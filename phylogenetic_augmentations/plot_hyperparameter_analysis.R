# ####################################################################################################################
# plot_hyperparameter_analysis.R
#
...
ggsave("../figures/figure_4.tiff", figure, units="in", width=7.5, height=7, device='tiff', dpi=350)
ggsave("../figures/figure_4.jpg", figure, units="in", width=7.5, height=7)
