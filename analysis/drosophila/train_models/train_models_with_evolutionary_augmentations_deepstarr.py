...
deepstarr.run_simple_model(file_folder, homolog_dir, output_folder, model_name_base, model_name_homologs, percent, True, fold)
deepstarr.run_simple_model(file_folder, homolog_dir, output_folder, model_name_base, model_name_no_homologs, percent, False, fold)
